          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <select {...register('category', { required: true })} className="input">
                {['music', 'sports', 'tech', 'art', 'food', 'comedy', 'theatre', 'other'].map(
                  (c) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="input"
                placeholder="e.g. NESCO Exhibition Centre"
              />
            </div>
            <div className="sm:col-span-2">
            ...
            <div>
              ...
              <input
                {...register('venueState', { required: true })}
                className="input"
            ...
            <div>
              ...
              <input
                {...register('venueCountry', { required: true })}
                className="input"
                placeholder="India"
              />
            </div>
            <div>
              ...
              <input
                {...register('venueCapacity', { required: true })}
                type="number"
                className="input"
                placeholder="5000"
              />
            ...
            <div key={field.id} className="bg-gray-800 rounded-xl p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div>
                  ...
                  <input
                    {...register(`sections.${idx}.name`, { required: true })}
                ...
                <div>
                  ...
                  <input
                    {...register(`sections.${idx}.rows`, { required: true })}
                    className="input py-2"
                    placeholder="A,B,C"
                  />
                </div>
                <div>
                  ...
                  <input
                    {...register(`sections.${idx}.seatsPerRow`, { required: true })}
                    type="number"
                    className="input py-2"
                    placeholder="10"
                  />
                ...
                <div>
                  ...
                  <input
                    {...register(`sections.${idx}.price`, { required: true })}
                    type="number"
                    className="input py-2"
                    placeholder="500"
                  />
